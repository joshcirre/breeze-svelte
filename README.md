<p align="center"><img src="/art/breezesvelte-logo.svg" alt="Logo Breeze Svelte"></p>
...
This is an **unofficial** port of the Breeze authentication scaffolding but with the Svelte install command. Laravel Breeze provides a minimal and simple starting point for building a Laravel application with authentication. Styled with Tailwind, Breeze publishes authentication controllers and views to your application that can be easily customized based on your own application's needs.
